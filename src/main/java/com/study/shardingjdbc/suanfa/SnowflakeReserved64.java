 ...
 */
@Slf4j
public class SnowflakeReserved64 implements Serializable {
    ...
    /**
     * 默认回拨时间，60S
     * 与业务场景有关，该时间取决于4096个id可以使用多长时间
     */
    public static long DEFAULT_TIME_OFFSET = 60000L;
     ...
     * @param workerId 终端ID
     */
    public SnowflakeReserved64(long workerId) {
     ...
     */
    public SnowflakeReserved64(long workerId, long dataCenterId) {
     ...
     */
    public SnowflakeReserved64(long workerId, long dataCenterId, boolean isUseSystemClock) {
     ...
     * @since 5.1.3
     */
    public SnowflakeReserved64(Date epochDate, long workerId, long dataCenterId, boolean isUseSystemClock) {
     ...
     * @since 5.8.0
     */
    public SnowflakeReserved64(Date epochDate, long workerId, long dataCenterId, boolean isUseSystemClock, long timeOffset) {
     ...
     * @since 5.8.0
     */
    public SnowflakeReserved64(Date epochDate, long workerId, long dataCenterId,
